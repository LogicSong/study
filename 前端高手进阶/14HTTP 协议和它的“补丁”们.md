...
![image-20210227133022242](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133022242.png)HTTP/0.9 通信示意图
...
![image-20210227133037457](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133037457.png)HTTP/1.0 通信示意图

### HTTP/1.1

随着互联网的迅速发展，HTTP/1.0 也已经无法满足需求，最核心的就是连接问题。具体来说就是 HTTP/1.0 每进行一次通信，都需要经历**建立连接、传输数据和断开连接**三个阶段。当一个页面引用了较多的外部文件时，这个建立连接和断开连接的过程就会增加大量网络开销。

为了解决这个问题，1999 年推出的 HTTP/1.1 版本增加了一个创建持久连接的方法。主要实现是当一个连接传输完成时，并不是马上进行关闭，而是继续复用它传输其他请求的数据，这个连接保持到浏览器或者服务器要求断开连接为止。


![image-20210227133050453](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133050453.png)HTTP/1.1 通信示意图
...
![image-20210227133106954](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133106954.png)TCP 三次握手
...
![image-20210227133123962](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133123962.png)利用 Wireshark 抓包 TCP 三次握手
...
![image-20210227133152510](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133152510.png)TCP 四次挥手
...
![image-20210227133218981](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133218981.png)利用 Wireshark 抓包 TCP 四次挥手
...
![image-20210227133242381](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133242381.png)HTTP/2 通信示意图

HTTP/2 也增加了一些其他的功能，比如通过压缩头部信息来减少传输体积，以及通过服务推送来减少客户端请求。相对而言，二进制分帧属于核心功能，所以其他功能就不做详细介绍了，有兴趣的话可以查看具体规范。


![image-20210227133302174](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133302174.png)通过开发者工具查看 HTTP/2 请求
...
![image-20210227133322442](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133322442.png)通过浏览器查看证书链
...
![image-20210227133336899](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133336899.png)通过开发者工具查看 HTTP/3 请求
...
![image-20210227133400203](/Users/hqer/Library/Application Support/typora-user-images/image-20210227133400203.png)
