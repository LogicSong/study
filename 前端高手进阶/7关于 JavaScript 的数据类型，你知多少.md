...
Null 数据类型和 Undefined 类似，只有唯一的一个值 null，都可以表示空值，甚至**我们通过 “==” 来比较它们是否相等的时候得到的结果都是 true，但 null 是 JavaScript 保留关键字，而 undefined 只是一个常量。**
...
![image-20210227131727056](/Users/hqer/Library/Application Support/typora-user-images/image-20210227131727056.png)
